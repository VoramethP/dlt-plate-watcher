...
ยังไม่ได้: สร้าง repo บน GitHub · ทดสอบส่ง Discord จริง (ยังไม่มี webhook URL ของผู้ใช้) · ยืนยันว่า file id คงที่ข้ามสัปดาห์
...
1. ผู้ใช้สร้าง Discord webhook → ใส่ `.env` → `npm run check` ยิงจริงครั้งแรก
