...
```bash
# ทีละหน้า (draw.io ≥ 27.0.2 นับหน้าจาก 1 · หน้า 99 raw = 8 · ใส่ 0 จะได้หน้าแรกเงียบ ๆ)
"/Applications/draw.io.app/Contents/MacOS/draw.io" -x -f png -p 8 -s 1.5 -b 20 -o drawio/png/99-raw.png drawio/dlt-plate-watcher.drawio
```

# ทุกหน้า
for i in 1 2 3 4 5 6 7 8; do "/Applications/draw.io.app/Contents/MacOS/draw.io" -x -f png -p $i -s 1.5 -b 20 -o "drawio/png/page-$i.png" drawio/dlt-plate-watcher.drawio; done
```
