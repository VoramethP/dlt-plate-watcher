...
แก้ [`numerology.json`](numerology.json) ให้ตรงตำราที่คุณเชื่อ: แต่ละ "สาย" ระบุผลรวมและคู่เลขที่เข้าข่าย การ์ดเลขในฝันจะมีส่วน 🔮 จัดกลุ่มเลขตามสาย
ค่าเริ่มต้นเป็นความเชื่อทั่วไป ไม่ใช่ข้อเท็จจริง · ลบไฟล์ทิ้งถ้าไม่ต้องการ
